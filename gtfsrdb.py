...
if os.environ.get('API_URL') is not None:
	r = requests.get(os.environ.get('API_URL')+"/status/gtfsrt-config")
	config['DB_URL'] = os.environ.get('DB_URL', r.json()['DB_URL'])
	config['DB_UPLOAD'] = os.environ.get('DB_UPLOAD', r.json()['DB_UPLOAD'])
	config['PB_DOWNLOAD'] = os.environ.get('PB_DOWNLOAD', r.json()['PB_DOWNLOAD'])
	config['PB_PATH'] = os.environ.get('PB_PATH', r.json()['PB_PATH'])
	config['SLEEP_TIME'] = os.environ.get('SLEEP_TIME', r.json()['SLEEP_TIME'])
	config['SLEEP_ADAPTIVE'] = os.environ.get('SLEEP_ADAPTIVE', r.json()['SLEEP_ADAPTIVE'])
	config['URL_TRIP_UPDATES_ENABLED'] = os.environ.get('URL_TRIP_UPDATES_ENABLED', r.json()['URL_TRIP_UPDATES_ENABLED'])
	config['URL_TRIP_UPDATES'] = os.environ.get('URL_TRIP_UPDATES', r.json()['URL_TRIP_UPDATES'])
	config['URL_VEHICLE_POSITIONS_ENABLED'] = os.environ.get('URL_VEHICLE_POSITIONS_ENABLED', r.json()['URL_VEHICLE_POSITIONS_ENABLED'])
	config['URL_VEHICLE_POSITIONS'] = os.environ.get('URL_VEHICLE_POSITIONS', r.json()['URL_VEHICLE_POSITIONS'])
	config['URL_ALERTS_ENABLED'] = os.environ.get('URL_ALERTS_ENABLED', r.json()['URL_ALERTS_ENABLED'])
	config['URL_ALERTS'] = os.environ.get('URL_ALERTS', r.json()['URL_ALERTS'])
else:
